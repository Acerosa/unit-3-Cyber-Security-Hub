    ...
    data.scenarios.forEach(function (scenario, index) {
      ...
      if (checked) {
        ...
        if (!correct) {
          ...
          var modelP1 = document.createElement('p');setAuthoredHtml(modelP1, '<strong>Vulnerability:</strong> ' + exp.vulnerability[0]);
          model.appendChild(modelP1);
          var modelP2 = document.createElement('p');setAuthoredHtml(modelP2, '<strong>Category:</strong> ' + exp.category);
          model.appendChild(modelP2);
          var modelP3 = document.createElement('p');setAuthoredHtml(modelP3, '<strong>Threat:</strong> ' + exp.threat[0]);
          model.appendChild(modelP3);
          var modelP4 = document.createElement('p');setAuthoredHtml(modelP4, '<strong>Likely incident:</strong> ' + exp.likelyIncident[0]);
          model.appendChild(modelP4);
          var modelP5 = document.createElement('p');setAuthoredHtml(modelP5, '<strong>CIA aims:</strong> ' + exp.ciaAims.join(', '));
          model.appendChild(modelP5);
          var modelP6 = document.createElement('p');setAuthoredHtml(modelP6, '<strong>Justification:</strong> ' + exp.justification);
