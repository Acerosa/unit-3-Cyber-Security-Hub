/**
 * Week 4 ethical-review discussion prompt.
 */
(function (global) {
  'use strict';
  ...
  global.Week4EthicalReview = Object.freeze({
    ...
    sentenceStarters: Object.freeze([
      'I argue that … because …',
      'Even if the claimed motivation is public good, …',
      'A claimed motivation does not change the legal position because …'
    ])
  });
})(window);
