(function () {
  ...
  function render() {
    ...
    timer.setAttribute('aria-live', 'polite');setAuthoredHtml(timer, '<span class="w6-timer-item"><strong>Timer:</strong> <span id="w6-timer-display">' +
    ...
    data.questions.forEach(function (q, index) {
      ...
      if (q.responseType === 'mcq') {
        ...
        textFields.mount(block, {
          ...
          minChars: 80,
          value: answers[q.id] || '',
          rows: q.commandWord === 'Discuss' ? 10 : 6,
          disabled: review,
      ...
      if (review) {
        ...
        scheme.className = 'w6-callout';setAuthoredHtml(scheme, '<p><strong>Mark scheme / guidance:</strong> ' +
          schemeText(q) +
          '</p>' +
