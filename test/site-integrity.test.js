...
test("GitHub Pages consumes review Core hub-bound onboarding, UI 0.1.10 and Content 0.1.4", function () {
  ...
  assert.match(workflow, /ref:\s*feat\/hub-bound-learner-onboarding/);
