/**
 * Serves Week 6 activity content using the Week 1 Activity API contract.
 *
 * Public getActivity responses omit correct answers, mark schemes and tutor notes.
 */

var Week6ActivityDataService = (function () {
  var CONTENT_SCHEMA_VERSION = '1.0';
  var API_VERSION = '1.0';

  var PACK_LOOKUP = {
    WEEK6_PACK_LO2_DIAGNOSTIC: function () {
      return WEEK6_PACK_LO2_DIAGNOSTIC;
    },
    WEEK6_PACK_ETHICAL_LEARNING: function () {
      return WEEK6_PACK_ETHICAL_LEARNING;
    },
    WEEK6_PACK_ETHICAL_CLASSIFICATION: function () {
      return WEEK6_PACK_ETHICAL_CLASSIFICATION;
    },
    WEEK6_PACK_LEGISLATION_LEARNING: function () {
      return WEEK6_PACK_LEGISLATION_LEARNING;
    },
    WEEK6_PACK_LEGISLATION_MATCHING: function () {
      return WEEK6_PACK_LEGISLATION_MATCHING;
    },
    WEEK6_PACK_OPERATIONAL_CONSIDERATIONS: function () {
      return WEEK6_PACK_OPERATIONAL_CONSIDERATIONS;
    },
    WEEK6_PACK_GOVERNMENT_INITIATIVES: function () {
      return WEEK6_PACK_GOVERNMENT_INITIATIVES;
    },
    WEEK6_PACK_NCSC_GUIDANCE: function () {
      return WEEK6_PACK_NCSC_GUIDANCE;
    },
    WEEK6_PACK_EXERCISE_DECISION_RECORD: function () {
      return WEEK6_PACK_EXERCISE_DECISION_RECORD;
    },
    WEEK6_PACK_SESSION1_REVIEW: function () {
      return WEEK6_PACK_SESSION1_REVIEW;
    },
    WEEK6_PACK_LEGISLATION_RETRIEVAL: function () {
      return WEEK6_PACK_LEGISLATION_RETRIEVAL;
    },
    WEEK6_PACK_EMPLOYEE_MONITORING: function () {
      return WEEK6_PACK_EMPLOYEE_MONITORING;
    },
    WEEK6_PACK_STAKEHOLDER_DEBATE: function () {
      return WEEK6_PACK_STAKEHOLDER_DEBATE;
    },
    WEEK6_PACK_DISCUSS_LEARNING: function () {
      return WEEK6_PACK_DISCUSS_LEARNING;
    },
    WEEK6_PACK_DISCUSS_PLANNER: function () {
      return WEEK6_PACK_DISCUSS_PLANNER;
    },
    WEEK6_PACK_OCR_PRACTICE: function () {
      return WEEK6_PACK_OCR_PRACTICE;
    },
    WEEK6_PACK_ANSWER_IMPROVEMENT: function () {
      return WEEK6_PACK_ANSWER_IMPROVEMENT;
    },
    WEEK6_PACK_REVISION_ORGANISER: function () {
      return WEEK6_PACK_REVISION_ORGANISER;
    }
  };
    ...
    if (action === 'getActivity' || action === 'activity') {
      ...
      if (!pack) {
        return errorEnvelope_(
          ...
          action,
          'UNKNOWN_ACTIVITY',
          'Activity ID is not recognised for Week 6.'
        );
      }
  ...
  function healthEnvelope_(requestId) {
    return ResponseFactory.apiEnvelope({
      ...
      data: {
        build: 'UNIT3-WEEK6-ACTIVITY-API-V1.0',
        ...
        week6Enabled: true,
        week6ActivityCount: getWeek6ManifestIds_().length,
  ...
  function buildManifestPayload_() {
    var activities = getWeek6ManifestIds_().map(function (id) {
      var entry = getWeek6ManifestEntry_(id);
      return {
  ...
  function markSection_(requestId, body) {
    ...
    if (!pack) {
      return errorEnvelope_(requestId, 'markSection', 'UNKNOWN_ACTIVITY', 'Activity ID is not recognised for Week 6.');
    }
  ...
  function submitAttempt_(requestId, body) {
    if (!areWeek6SubmissionsOpen_()) {
      return errorEnvelope_(
        ...
        'submitAttempt',
        'SUBMISSIONS_CLOSED',
        'Week 6 submissions are currently closed.'
      );
    }
  ...
  function bootstrapSetup_(requestId, params) {
    ...
    if (props.getProperty('WEEK6_BOOTSTRAP_DONE') === 'true') {
      return errorEnvelope_(
        requestId,
        'bootstrapSetup',
        'BOOTSTRAP_DONE',
        'Week 6 bootstrap has already been completed.'
      );
    }
    if (String(params.confirm || '') !== 'Unit3-Week6-Bootstrap-Once') {
      return errorEnvelope_(
        requestId,
        'bootstrapSetup',
        'BOOTSTRAP_FORBIDDEN',
    ...
    try {
      var summary = runWeek6DeploymentBootstrap();
      props.setProperty('WEEK6_BOOTSTRAP_DONE', 'true');
  ...
  function hasAnswer_(question, value) {
    if (question.questionType === 'classification') {
      if (value && typeof value === 'object' && !Array.isArray(value)) {
        ...
        // Week 6 impact-category classification object
  ...
  function parseJsonBody_(e) {
    ...
    try {
      ...
      Logger.log('Week6ActivityDataService parse error: ' + err);
