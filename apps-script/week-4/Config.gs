/**
 * Week 4 Apps Script API configuration.
 *
...
var CONFIG = Object.freeze({
  ...
  weekResultsSheetName: 'Week 4 Results',
  errorsSheetName: 'Errors and Rejections',
  acceptingSubmissionsProperty: 'WEEK4_ACCEPTING_SUBMISSIONS'
});
...
function checkWeek4Config() {
  ...
  if (CONFIG.weekNumber !== 4) {
    ok = false;
    messages.push('CONFIG.weekNumber must be 4.');
  }
  ...
  try {
    ...
    Logger.log('checkWeek4Config open error: ' + err);
